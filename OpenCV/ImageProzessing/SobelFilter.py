...
sobel_horizontal_Kernelsize3=cv2.Sobel(img,cv2.CV_64F,1,0,ksize=3)
sobel_vertical_Kernelsize3=cv2.Sobel(img,cv2.CV_64F,0,1,ksize=3)

sobel_horizontal_Kernelsize7=cv2.Sobel(img,cv2.CV_16U,1,0,ksize=7)
sobel_vertical_Kernelsize7=cv2.Sobel(img,cv2.CV_16U,0,1,ksize=7)
